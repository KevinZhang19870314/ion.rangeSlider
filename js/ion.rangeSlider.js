...
(function(factory) {
    ...
    var base_html =
        ...
        '<span class="irs-bar-left"></span>' +
        '<span class="irs-bar"></span>' +
        '<span class="irs-bar-right"></span>';
    ...
    IonRangeSlider.prototype = {
        ...
        append: function() {
            ...
            this.$cache.barLeft = this.$cache.cont.find(".irs-bar-left");
            this.$cache.bar = this.$cache.cont.find(".irs-bar");
            this.$cache.barRight = this.$cache.cont.find(".irs-bar-right");
